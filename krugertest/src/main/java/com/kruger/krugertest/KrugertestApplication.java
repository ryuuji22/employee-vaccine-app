...
public class KrugertestApplication {

	private final ApplicationContext applicationContext;

	public KrugertestApplication(ApplicationContext applicationContext) {
	...
	public static void main(String[] args) {
		SpringApplication.run(KrugertestApplication.class, args);
	}
